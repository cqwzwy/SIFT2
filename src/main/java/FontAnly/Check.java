...
public class Check {
   ...
   public static void main(String[] args) throws InterruptedException {
	  File files=new File("C:\\Users\\22682\\Desktop\\X66A]GDSJ9SE2NM}AB1$[5Y.png");
	  ...
	  // for(int j=0;;j++) {
	   //for(int i=0;i<fls.length;i++) {
		   String path="C:\\Users\\22682\\Desktop\\X66A]GDSJ9SE2NM}AB1$[5Y.png";
		   try {
	           long now = System.currentTimeMillis();
	           String savepath="C:\\Users\\22682\\Desktop\\shuju.txt";
